...
const Explain = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col  items-center justify-center px-4 py-8 ">
      ...
      <div className="flex flex-col lg:flex-row gap-20 lg:ml-20">

      <div className="w-full max-w-6xl flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-8">
        {/* Buttons Section */}
        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-8">
          ...
          {/* Explanation Section */}
          <div className="w-full max-w-md bg-white rounded-lg p-6  text-center lg:text-left">
...
const buttonArray = [
  ...
  },
  {
    id: 4,
    title: "Video",
    logo: <Youtube className="w-5 h-5" />,
  },
  {
    id: 5,
    title: "App",
    logo: <LayoutGrid className="w-5 h-5" />,
  },
];
...
const cardData = [
  {
    id: 1,
    title: "Search",
    logo: "https://www.gstatic.com/marketing-cms/assets/images/ads/7a/b9/ca3a48c34e4f8329720fac2040ad/unnamed-22.png",
    head: "Some thing",
    para: "Build awareness and consideration with memorable, visually engaging ads that reach your audience when they're online, checking Gmail or using mobile apps.",
    butitle: "another thing ",
  },
  {
    id: 2,
    title: "Display",
    logo: "https://www.gstatic.com/marketing-cms/assets/images/ads/b1/1f/ffe2d28447759e2feffc7912fa50/unnamed-23.png",
    head: "Some thing",
    para: "Build awareness and consideration with memorable, visually engaging ads that reach your audience when they're online, checking Gmail or using mobile apps.",
    butitle: "another thing ",
  },
  {
    id: 3,
    title: "Shopping",
    logo: "https://www.gstatic.com/marketing-cms/assets/images/ads/4c/02/71ef56944be8a24e2e114d1e9ad4/unnamed-25.png",
    head: "Some thing",
    para: "Build awareness and consideration with memorable, visually engaging ads that reach your audience when they're online, checking Gmail or using mobile apps.",
    butitle: "another thing ",
  },
  ...
  },
  {
    id: 5,
    title: "App",
    logo: "https://www.gstatic.com/marketing-cms/assets/images/ads/8c/e4/aa819d6541bb8619c619dac3b8f1/unnamed-26.png",
    head: "Some thing",
    para: "Build awareness and consideration with memorable, visually engaging ads that reach your audience when they're online, checking Gmail or using mobile apps.",
    butitle: "another thing ",
  },
